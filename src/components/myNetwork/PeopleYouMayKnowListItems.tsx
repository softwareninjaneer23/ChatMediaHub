...
//custom
import { PeopleYouMayKnowList } from "../../types";
import { COLORS, images } from "../../constants";

type PeopleYouMayKnowListProps = {
  peopleYouMayKnow: PeopleYouMayKnowList;
};

export default function PeopleYouMayKnowListItems({
  peopleYouMayKnow,
  ...
  return (
    <View style={styles.peopleYouMayKnowContainer}>
      <View style={styles.peopleYouMayKnowContentContainer}>
        ...
        <ImageBackground
          source={
            peopleYouMayKnow.backImage
              ? { uri: peopleYouMayKnow.backImage }
              : images.emptyImage
          }
        ...
        <View style={styles.peopleYouMayKnowUserImageContainer}>
          {peopleYouMayKnow.openToWork ? (
            ...
            >
              <Image
                source={{ uri: peopleYouMayKnow.userImage }}
        ...
        <View style={styles.peopleYouMayKnowUserInfoContainer}>
          ...
          >
            {peopleYouMayKnow.userPosition} at{" "}
            <Text style={styles.peopleYouMayKnowUserDetailsTextItem}>
              {peopleYouMayKnow.userCompany}
            </Text>
          </Text>
        </View>
        ...
        <View style={styles.peopleYouMayKnowMutualContainer}>
          {peopleYouMayKnow.hasAJob ? (
            <>
              <Entypo name="slideshare" size={18} color={COLORS.white} />
              <Text style={styles.peopleYouMayKnowMutualTextItem}>
                {" "}
                {peopleYouMayKnow.userMutualConnections > 500
                  ? "500+"
                  : peopleYouMayKnow.userMutualConnections}{" "}
                mutual connections
              </Text>
            </>
          ) : (
